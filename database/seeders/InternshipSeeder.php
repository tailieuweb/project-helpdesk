...
class InternshipSeeder extends FoostartSeeder
{
    private $obj_pexcel;
    ...
    public function __construct() {
        ...
        // Pexcel object
        $this->obj_pexcel = new Internship();
    ...
    public function run()
    {
        ...
        DB::table('contexts')->insert([
            $this->prefix_context . 'name' => 'Admin internship',
            $this->prefix_context . 'key' => 'abee417e2dddc5240b586d466',
            $this->prefix_context . 'ref' => 'admin/internship',
            'status' => 99,
            'created_user_id' => 1,
            'updated_user_id' => 1,
